...
- :white_check_mark: [**2024-01-13**] Our extended journal version [BPJDetPlus](https://github.com/hnuzhy/BPJDet/tree/BPJDetPlus) has been accepted by **TPAMI'2024**.
- :white_check_mark: [**2023-12-13**] We built our projects of **BPJDet** and **BPJDetPlus** in one unified website [BPJDet Project](https://hnuzhy.github.io/projects/BPJDet/).
- :white_check_mark: [**2023-07-21**] We won the **Best Student Paper Runner Up** award in **ICME'2023** of our conference paper!
- :white_check_mark: [**2023-06-13**] We have released all pretrained models of both new tasks: `body-parts joint detection` and `body-hand joint detection and hand contact estimation` in [Hugging Face](https://huggingface.co/HoyerChou/BPJDet#bpjdetplus).
- :white_check_mark: [**2023-06-13**] We have released a new branch [BPJDetPlus](https://github.com/hnuzhy/BPJDet/tree/BPJDetPlus) for the journal verison with updated code and detailed descriptions. It has various new functions (`Multiple Body-Parts Joint Detection` and two downstream applications including `Body-Head for Accurate Crowd Counting` and `Body-Hand for Hand Contact Estimation`). Please feel free to follow it!
- :white_check_mark: [**2023-04-24**] The extended journal version of our conference paper is released in [BPJDet: Extended Object Representation for Generic Body-Part Joint Detection](https://arxiv.org/abs/2304.10765v2)
- :white_check_mark: [**2023-03-15**] We have decided to release our BPJDet-S/M/L pretrained models on CrowdHuman and BodyHands in [Hugging Face](https://huggingface.co/HoyerChou/BPJDet). Please follow the [[Inference](#inference)] section to test on your own images/videos.
